...
First, I will comment on the process used to generate the figures. I tried to make the table and plot display side-by-side using a css file posted by Jenny Bryan and authored by Omar AlOmeir at this [gist](https://gist.github.com/jennybc/e9e9aba6ba18c72cec26#file-2015-03-02_plot-next-to-table-rmd). However, the markdown filetype can not use the css used to create the side-by-side plots. Further, the html document, which could use the css, was too large to display on github, making my attempt unsuccessful. The bars on the line plot are the 25% and 75% quantiles of life expectancy by continent. The table was generated by using the spread function from `tidyr`, which is part of the tidyverse package. I wished to have continents for the rows and years for the columns, to make it easier to read. I used this function, though it is not in `dplyr`, because it provides an elegant way of performing a common task, and thus greatly improves readability.
...
![](hw03-exercise_files/figure-markdown_github/unnamed-chunk-1-1.png)
...
![](hw03-exercise_files/figure-markdown_github/lifeExpGreaterThanAmountGraphics1-1.png)
